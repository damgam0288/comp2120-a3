...
This was an assignment for a university project where we were tasked with making a very simple game engine that is entirely in the Java console. 

# Features

## Designers
* Make your own game by editing the JSON files in the "assets" folder.
* Set the number of enemies, NPCs, the available items for NPCs to give to the Player, and the floor map for the game world.
